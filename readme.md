...
On MacOs/Linux type "python3 -m env .venv", this creates a virtual environment. Select yes in the pop-up to use the new virtual envirnoment.
...
Now that library can be imported in code.
